/**
 * Data wilayah untuk saran domisili.
 *
 * Alur pengisian: negara dahulu, lalu — khusus Indonesia — provinsi dan
 * kabupaten/kota. Negara selain Indonesia cukup mengisi kota secara bebas,
 * karena mendaftar seluruh wilayah dunia tidak sebanding manfaatnya.
 *
 * Daftar kabupaten/kota disusun berdasarkan pembagian 38 provinsi. Bila nanti
 * dipakai untuk keperluan resmi, cocokkan ulang dengan data BPS/Kemendagri
 * terbaru — pemekaran wilayah membuat daftar seperti ini cepat usang.
 */
...
/** Provinsi Indonesia → kabupaten/kota di dalamnya. */
export const WILAYAH_INDONESIA: Record<string, string[]> = {
  Aceh: [
...
export const PROVINSI = Object.keys(WILAYAH_INDONESIA);

/** Kabupaten/kota untuk satu provinsi; kosong bila provinsi belum dipilih. */
export const kotaDi = (provinsi: string | null | undefined) =>
  (provinsi && WILAYAH_INDONESIA[provinsi]) || [];
